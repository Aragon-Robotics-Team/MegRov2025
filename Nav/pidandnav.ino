...
void loop() {
  if (Serial.available()) {
    ...
    if ((VTR_PWM == 1501) && (VTL_PWM == 1501) && (VBR_PWM == 1501) && (VBL_PWM == 1501)) {
...
//      Serial.println(pitch);
      ...
      VTR_PWM = PID(depth, goal) + 1500;
      VTL_PWM = PID(depth, goal) + 1500;
      VBR_PWM = PID(depth, goal) + 1500;
      VBL_PWM = PID(depth, goal) + 1500;
    }
